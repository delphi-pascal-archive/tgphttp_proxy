...
const
  FTPTstVersion      = 230;
  CopyRight : String = ' FtpTst (c) 1997-2005 F. Piette V2.30 ';
...
begin
    if not FInitialized then begin
        ...
        AuthSslCheckBox.Checked        := Boolean(IniFile.ReadInteger(SectionData, KeyAuthSSL , 0));
...
begin
    ...
    IniFile.WriteInteger(SectionData, KeyAuthSSL , Ord(AuthSslCheckBox.Checked));
